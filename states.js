  ...
  UK: {
    ...
    games: [
      ...
      { name: "Lotto HotPicks", meta: "pick 1–5 of the Lotto balls · fixed prizes to £350K",
        links: [["Fixed prizes &amp; odds", "game.html?game=uk_lotto_hotpicks"]] },
      { name: "EuroMillions HotPicks", meta: "pick 2–5 of the EuroMillions balls · match 5 wins £1M",
        links: [["Fixed prizes &amp; odds", "game.html?game=uk_em_hotpicks"]] },
    ],
    national: [],
  },
  NY: {
  ...
  SC: {
    ...
    games: [
      { name: "Palmetto Cash 5", meta: "5 of 38 · daily · cash jackpot from $100K",
        links: [["Jackpot, odds &amp; prizes", "game.html?game=sc_palmetto5"]] },
      { name: "Pick 3", meta: "3-digit · twice daily · $500 straight",
        links: [["Results, odds &amp; payouts", "game.html?game=sc_pick3"]] },
      { name: "Pick 4", meta: "4-digit · twice daily · $5K straight",
        links: [["Results, odds &amp; payouts", "game.html?game=sc_pick4"]] },
    ],
    national: [
      { name: "Powerball", meta: "Multi-state jackpot · Mon · Wed · Sat",
        links: [["Value, odds &amp; EV", "game.html?game=powerball"]] },
  ...
  KS: {
    ...
    games: [
      { name: "Super Kansas Cash", meta: "5 of 32 + Cash Ball · Mon · Wed · Sat · jackpot from $100K",
        links: [["Jackpot, odds &amp; prizes", "game.html?game=ks_superkscash"]] },
      { name: "Pick 3", meta: "3-digit · twice daily · $500 exact",
        links: [["Results, odds &amp; payouts", "game.html?game=ks_pick3"]] },
    ],
    national: [
      { name: "Powerball", meta: "Multi-state jackpot · Mon · Wed · Sat",
        links: [["Value, odds &amp; EV", "game.html?game=powerball"]] },
